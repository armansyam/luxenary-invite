...
export default function EditInvitation() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-24 font-sans">
      ...
      {/* Smart Detector: Pengingat Ringkas Foto Personal (Slim & Minimalist) */}
      {Boolean(invitation.themeId) && (!media["GROOM_PHOTO"] || !media["BRIDE_PHOTO"] || !media["LANDING_COVER"]) && (
        <div className="bg-amber-50/70 border border-amber-200/80 rounded-xl px-3.5 py-2 sm:py-2.5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 shadow-2xs">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <p className="text-xs text-stone-700 truncate">
              <span className="font-semibold text-amber-950">Foto belum lengkap:</span>{" "}
              <span className="font-medium text-amber-900">{[
                !media["LANDING_COVER"] && "Sampul Pop-Up",
                !media["GROOM_PHOTO"] && "Mempelai Pria",
                !media["BRIDE_PHOTO"] && "Mempelai Wanita",
          ...
          <div className="flex items-center gap-1.5 shrink-0 self-end sm:self-center">
            {!media["LANDING_COVER"] && (
              <button
                ...
                className="px-2.5 py-1 bg-white hover:bg-amber-100/70 text-amber-900 border border-amber-300/80 font-semibold rounded-lg text-[11px] transition cursor-pointer shadow-2xs"
              >
                + Sampul
              </button>
            )}
