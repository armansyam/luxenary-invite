                      ...
                      <div className="w-full space-y-3">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <span className="text-base font-bold text-white">{items.length} Layanan Terpilih</span>
                          </div>
            ...
            <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl text-center space-y-3">
              <div className="space-y-1">
                <span className="text-xs font-semibold text-emerald-400 block">
                  Bukti transfer Anda tersimpan aman dan sedang dalam antrean verifikasi admin.
                </span>
                <span className="text-[11px] text-stone-400 block">
                  Pesanan tidak dapat dibatalkan atau diubah selama proses pemeriksaan struk berlangsung.
                </span>
              </div>
              <Link
                href="/dashboard"
                className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold rounded-xl transition shadow-xs cursor-pointer"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
                <span>Kembali ke Dasbor Klien</span>
              </Link>
            </div>
          ) : (
