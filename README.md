...
- **Homepage Hero Mockup & Standarisasi Aset Visual (< 200 KB WebP):** Menyelaraskan mockup perangkat utama iPhone 16 Pro pada landing page menjadi full-bleed screenshot murni berlayar penuh (`object-fit: cover`), terbebas dari bingkai kubah kaku maupun duplikasi teks. Seluruh aset homepage dan thumbnail showroom dikompresi ke format WebP dengan batas Retina 2048px dan unsharp mask sharpening (`sharp.sharpen()`) dengan bobot 100% di bawah 200 KB untuk menjamin skor LCP Google Core Web Vitals < 2.5s.
