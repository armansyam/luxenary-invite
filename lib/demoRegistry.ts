...
export function composeDemoTemplateData(
  ...
  return {
    ...
    quoteSectionTitle: (customData as any)?.customLabels?.quoteTitle || blueprint.quoteSectionTitle,
    ...
    eventsTitle: (customData as any)?.customLabels?.eventsTitle || blueprint.eventsSectionTitle || "Rangkaian Acara",
    eventsEyebrow: (customData as any)?.customLabels?.eventsEyebrow || blueprint.eventsSectionEyebrow || "AGENDA ACARA",
    storySectionTitle: (customData as any)?.customLabels?.storyTitle || blueprint.storySectionTitle || "Kisah Cinta Kami",
    storySectionEyebrow: (customData as any)?.customLabels?.storyEyebrow || blueprint.storySectionEyebrow || "OUR JOURNEY",
    storyTitle: (customData as any)?.customLabels?.storyTitle || blueprint.storySectionTitle || "Kisah Cinta Kami",
    storyEyebrow: (customData as any)?.customLabels?.storyEyebrow || blueprint.storySectionEyebrow || "OUR JOURNEY",
    gallerySectionTitle: (customData as any)?.customLabels?.galleryTitle || blueprint.gallerySectionTitle || "Our Moments",
    gallerySectionEyebrow: (customData as any)?.customLabels?.galleryEyebrow || blueprint.gallerySectionEyebrow || "GALLERY",
    galleryTitle: (customData as any)?.customLabels?.galleryTitle || blueprint.gallerySectionTitle || "Our Moments",
    galleryEyebrow: (customData as any)?.customLabels?.galleryEyebrow || blueprint.gallerySectionEyebrow || "GALLERY",
    galleryQuote: (customData as any)?.customLabels?.galleryQuote || blueprint.galleryQuote || "",
    wishesSectionTitle: (customData as any)?.customLabels?.wishesTitle || blueprint.wishesSectionTitle || "Doa & Ucapan",
    wishesSectionSub: (customData as any)?.customLabels?.wishesSub || blueprint.wishesSectionSub || "",
    wishesSectionEyebrow: (customData as any)?.customLabels?.wishesEyebrow || "WISHES & RSVP",
    wishesTitle: (customData as any)?.customLabels?.wishesTitle || blueprint.wishesSectionTitle || "Doa & Ucapan",
    wishesEyebrow: (customData as any)?.customLabels?.wishesEyebrow || "WISHES & RSVP",
    rsvpTitle: (customData as any)?.customLabels?.rsvpTitle || blueprint.rsvpTitle || "Konfirmasi Kehadiran",
    rsvpBtnText: (customData as any)?.customLabels?.rsvpBtnText || blueprint.rsvpBtnText || "Kirim Konfirmasi & Doa",
